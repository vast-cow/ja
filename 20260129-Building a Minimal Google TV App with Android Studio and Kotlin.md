...
description: "対象：Google TV（= Android TV OS） 目的：Android Studio + Kotlin で 最小構成アプリを起動できるところまで。 利用環境（Android Studio） 1. 新規プロジェクト作成 1. Android Studio → New Project 2. テ…"
---
