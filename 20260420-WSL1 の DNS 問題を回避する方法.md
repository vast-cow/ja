...
description: "WSL1 を使っていると、名前解決が不安定になったり、resolv.conf が意図せず上書きされて DNS がうまく引けなくなったりすることがあります。 今回は、その問題をできるだけ安定して回避する方法をまとめます。 やることは大きく分けて 3 つです。 まず、WSL が DNS 設定を自動生成し…"
---
