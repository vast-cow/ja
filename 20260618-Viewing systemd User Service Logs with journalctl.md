...
description: "systemctl --user status hoge で確認している user service のログは、journalctl では --user-unit を使って確認できる。 直近のログだけ見るなら次のようにする。 リアルタイムで追跡したい場合は -f を付ける。 今回のブート以降のログに絞…"
---
