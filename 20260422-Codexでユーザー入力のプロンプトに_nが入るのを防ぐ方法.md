...
description: "Codexを使っていると、プロンプト入力欄に意図しない \\n が入ってしまい、文章が崩れたり、入力しづらく感じたりすることがあります。ここでは、その問題を防ぐためのUserScriptの目的と使い方を、簡単にまとめます。 これは何をするものか このUserScriptは、ChatGPT Codex…"
---
