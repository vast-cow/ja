...
description: "前提 ここでは「QEMU COW イメージ」を、通常使われる qcow2 形式として扱います。QEMU は raw と qcow2 を主要なディスクイメージ形式として扱い、qcow2 は小さなイメージ、圧縮、複数スナップショットなどに対応する形式です。([QEMU][1]) Ubuntu では qe…"
---
