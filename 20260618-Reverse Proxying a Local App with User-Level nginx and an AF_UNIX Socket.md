...
description: "複数のローカル Web アプリを手元で動かしていると、URL の prefix ごとに別アプリへ振り分けたいことがある。 たとえば、 へのアクセスを、別プロセスとして起動しているアプリに reverse proxy したい。 このとき、nginx を使うと簡単にできる。ただし、通常のシステム ngi…"
---
